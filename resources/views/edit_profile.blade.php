    ...
    <div class="signup">
                ...
                <form method="POST" action="{{ route('edit_profile') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="security_ques" type="text" class="form-control @error('security_ques') is-invalid @enderror" name="security_ques" value="{{$user->security_ques}}" required autocomplete="security_ques" autofocus>
